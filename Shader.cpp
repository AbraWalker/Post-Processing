...
ID3D11PixelShader*  gTintCyclePostProcess  = nullptr;
...
ID3D11PixelShader* gBlur2PostProcess       = nullptr;
...
bool LoadShaders()
{
	...
	gTintCyclePostProcess  = LoadPixelShader("TintCycle_pp");
	...
	gBlur2PostProcess      = LoadPixelShader("Blur2_pp");
	gWaterPostProcess	   = LoadPixelShader("Water_pp");
	gPixelationPostProcess = LoadPixelShader("Pixelation_pp");
	...
	if (gBasicTransformVertexShader == nullptr || gPixelLightingVertexShader == nullptr ||
		...
		gTintPostProcess            == nullptr || gTintCyclePostProcess      == nullptr ||
		gHeatHazePostProcess       == nullptr  ||
		...
		gWaterPostProcess			== nullptr || gPixelationPostProcess     == nullptr ||
		gBlur2PostProcess == nullptr)
	{
...
void ReleaseShaders()
{
	...
	if (gBlur2PostProcess)				gBlur2PostProcess->Release();
	...
	if (gTintCyclePostProcess)        gTintCyclePostProcess      ->Release();
